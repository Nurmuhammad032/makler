                ...
                <div className="edit__left__card">
                    ...
                    <div className="editpage__input">
                        ...
                        >
                            ...
                            <select className="select price__select" name="ergerg" id="" placeholder="y.e">
                            <option className="select__option" value="price"></option>
                            <option className="select__option" value="price">y.e</option>
                            <option className="select__option" value="price">$$$</option>
                            ...
                            <label htmlFor="">
                                ...
                                <input className='phone-number' type={"number"}  placeholder={"+99890 123-45-67"} />
                            </label>
                        </form>
